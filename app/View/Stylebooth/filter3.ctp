...
<div class="col-md-3">
	<div>
		<a class="thumbnail" href="#" onclick="setBodyType(<?php echo $b['BodyType']['id']; ?>)"><img src="/files/body_types/<?php if ($b['BodyType']['image']) { echo $b['BodyType']['image']; } else { echo 'imagecara.jpg'; } ?>" alt="<?php echo $b['BodyType']['name']; ?>" alt="<?php echo $b['BodyType']['name']; ?>" data-toggle="tooltip" title="<?php echo $b['BodyType']['name']; ?>"></a>
	</div>
</div>
<?php } ?>
</div>
